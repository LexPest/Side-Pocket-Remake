...
namespace DragonOgg.TagLibSharp.Mpeg {
	/// <summary>
	///    This class extends <see cref="NonContainer.File" /> to
	///    provide tagging and properties support for MPEG-1, MPEG-2, and
	///    MPEG-2.5 audio files.
	/// </summary>
	/// <remarks>
	///    A <see cref="Id3v1.Tag" /> and <see
	///    cref="Id3v2.Tag" /> will be added automatically to any
	...
	public class AudioFile : NonContainer.File
	{
		...
		/// </returns>
		/// <remarks>
		///    If a <see cref="Id3v2.Tag" /> is added to the
		///    current instance, it will be placed at the start of the
		///    file. On the other hand, <see cref="Id3v1.Tag" />
		///    <see cref="Ape.Tag" /> will be added to the end of
		...
		/// </param>
		/// <returns>
		///    A <see cref="Properties" /> object describing the
