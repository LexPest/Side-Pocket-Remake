...
namespace DragonOgg.TagLibSharp.Ape {
	/// <summary>
	///    This class extends <see cref="TagLibSharp.Tag" /> and implements <see
	...
	/// </summary>
	public class Tag : TagLibSharp.Tag, IEnumerable<string>
	{
...
#region Private Fields
		...
		/// </exception>
		public Tag (TagLibSharp.File file, long position)
		{
			if (file == null)
		...
		/// </summary>
		/// <param name="file">
		///    A <see cref="TagLibSharp.File" /> object to read the tag from.
		/// </param>
		/// <param name="position">
		...
		///    than the size of the file.
		/// </exception>
		protected void Read (TagLibSharp.File file, long position)
		{
			if (file == null)
				throw new ArgumentNullException ("file");
		...
		///    <see cref="TagLibSharp.Tag" />, optionally overwriting
		///    existing values.
		/// </summary>
		/// <param name="target">
		///    A <see cref="TagLibSharp.Tag" /> object containing the target
		...
		///    cref="Tag" /> a complete copy of all values
		...
		/// </exception>
		public override void CopyTo (TagLibSharp.Tag target, bool overwrite)
		{
			if (target == null)
