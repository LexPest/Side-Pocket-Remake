...
namespace DragonOgg.TagLibSharp.Id3v2.Frames {
	/// <summary>
	...
	///    <para>Additionally, <see cref="TagLibSharp.Tag.Pictures" /> provides a
	...
	public class AttachedPictureFrame : Frame, IPicture
	{
		...
		///    <para>Additionally, <see cref="TagLibSharp.Tag.Pictures" />
