...
using System.Text;
using DragonOgg.TagLibSharp.Id3v2.Frames;

namespace DragonOgg.TagLibSharp.Id3v2 {
	/// <summary>
	...
	///    writing ID3v2 tags.
	/// </summary>
	public class Tag : TagLibSharp.Tag, IEnumerable<Frame>, ICloneable
	{
...
#region TagLib.Tag
		...
		public override string [] Genres {
			get {
				...
				foreach (string genre in text) {
					...
					string genre_from_index =
						TagLibSharp.Genres.IndexToAudio (
							genre);
			...
			set {
				...
				for (int i = 0; i < value.Length; i ++) {
					int index = TagLibSharp.Genres.AudioToIndex (
						value [i]);
		...
		///    cref="Ape.Tag" /> a complete copy of all values
