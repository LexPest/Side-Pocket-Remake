...
namespace DragonOgg.TagLibSharp.Asf {
	/// <summary>
	///    This class extends <see cref="TagLibSharp.File" /> to provide tagging
	...
	public class File : TagLibSharp.File
	{
		...
		/// </returns>
		public override TagLibSharp.Tag GetTag (TagTypes type, bool create)
		{
