...
using DragonOgg.TagLibSharp.Ogg;

namespace DragonOgg.TagLibSharp.Flac {
	/// <summary>
	...
	/// </summary>
	/// <remarks>
	///    A <see cref="XiphComment" /> will be added
	...
	public class Metadata : CombinedTag
	{
		...
		/// </summary>
		/// <value>
		///    A bitwise combined <see cref="TagLibSharp.TagTypes" /> value
