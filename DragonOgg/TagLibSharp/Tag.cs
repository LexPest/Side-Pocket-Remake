...
namespace DragonOgg.TagLibSharp {
	/// <summary>
	...
	public abstract class Tag
	{
		...
		///    example, <see cref="Id3v2.Tag" /> objects have a
		///    value of <see cref="TagLibSharp.TagTypes.Id3v2" />. However,
		///    for tags of type <see cref="CombinedTag" /> may
		...
		///    from one <see cref="Id3v2.Tag" /> to another:
		...
		///    <see cref="Tag" />, optionally overwriting
		///    existing values.
		/// </summary>
		/// <param name="target">
		///    A <see cref="Tag" /> object containing the target tag to
		...
		///    For example, <see cref="Id3v2.Tag" /> will copy
