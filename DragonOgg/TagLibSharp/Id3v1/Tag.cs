...
#region TagLib.Tag
		...
		///    cref="TagLibSharp.Genres.Audio" />. All other values will
		///    result in the property being cleared.
		/// </remarks>
		public override string [] Genres {
			get {
				string genre_name =
					TagLibSharp.Genres.IndexToAudio (genre);
			...
			set {
				genre = (value == null || value.Length == 0) ?
					(byte) 255 :
					TagLibSharp.Genres.AudioToIndex (
						value [0].Trim ());
			}
		}
